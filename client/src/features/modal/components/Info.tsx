  ...
  return (
    <>
      ...
      <Modal.Body>
        <div>
          <p>
            Usá el ratón o el dedo para conectar las letras en la grilla para
            formar palabras.
          </p>
          ...
          <p>etc.</p>
          <i>
            Consejo: Cada tablero tendrá una palabra que tiene al menos 8
            letras. Recordá prestarle atención!
          </i>
          <p>
            Conseguí puntos para subir de nivel. Intentá conseguir el nivel
            máximo cada día!
          </p>
          <h1>Más</h1>
          <p>
            Wordhuntle se reinicia todos los días a las 8pm EST. Volvé cada día
            para jugar un tablero nuevo!
          </p>
        </div>
      </Modal.Body>
    </>
